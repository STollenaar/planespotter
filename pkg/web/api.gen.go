...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc(http.MethodGet+" "+options.BaseURL+"/api/healthcheck", wrapper.GetHealthcheck)
...
type GetHealthcheck200JSONResponse HealthcheckResponse
...
type GetHealthcheck503JSONResponse HealthcheckResponse

func (response GetHealthcheck503JSONResponse) VisitGetHealthcheckResponse(w http.ResponseWriter) error {
